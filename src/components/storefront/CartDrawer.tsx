    ...
    <Sheet open={isOpen} onOpenChange={setIsOpen}>
      ...
      <SheetContent className="w-full sm:max-w-lg flex flex-col h-full">
        <SheetHeader className="flex-shrink-0">
          <SheetTitle className="font-['Playfair_Display']">Shopping Cart</SheetTitle>
          <SheetDescription>
          ...
          {items.length === 0 ? (
            ...
            <>
              ...
              <div className="flex-shrink-0 space-y-4 pt-4 border-t border-border bg-background">
                ...
                <Button onClick={handleCheckout} className="w-full bg-primary hover:bg-primary/80 text-primary-foreground" size="lg" disabled={items.length === 0 || isLoading || isSyncing}>
